...
describe("normalización y seguridad", () => {
  ...
  it("exige un celular privado para reportar una persona", () => expect(reportSchema.safeParse({ fullName:"Persona Prueba",lastSeenDate:"2026-08-01",location:"Lugar de prueba",reporterName:"Alguien",consent:true,goodFaith:true }).success).toBe(false));
  it("acepta un reporte simplificado de buena fe", () => expect(reportSchema.safeParse({ fullName:"Persona Prueba",lastSeenDate:"2026-08-01",location:"Lugar de prueba",reporterName:"Alguien",phone:"3000000000",consent:true,goodFaith:true }).success).toBe(true));
