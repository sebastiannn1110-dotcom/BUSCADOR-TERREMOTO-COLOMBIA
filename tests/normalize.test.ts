...
describe("normalización y seguridad", () => {
  ...
  it("acepta un reporte completo con nombre y celular", () => expect(reportSchema.safeParse({ fullName:"Persona Prueba",isMinor:false,lastSeenDate:"2026-08-01",location:"Lugar de prueba",circumstances:"Descripción suficiente",reporterName:"Alguien",phone:"3000000000",consent:true }).success).toBe(true));
