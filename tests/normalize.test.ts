...
describe("normalización y seguridad", () => {
  ...
  it("exige un contacto privado para reportar una persona", () => expect(reportSchema.safeParse({ fullName:"Persona Prueba",lastSeenDate:"2026-08-01",location:"Lugar de prueba",circumstances:"Descripción de prueba suficiente",reporterName:"Alguien",preferredContact:"either",consent:true,goodFaith:true }).success).toBe(false));
  it("acepta un reporte completo de buena fe", () => expect(reportSchema.safeParse({ fullName:"Persona Prueba",lastSeenDate:"2026-08-01",location:"Lugar de prueba",circumstances:"Descripción de prueba suficiente",reporterName:"Alguien",phone:"3000000000",preferredContact:"phone",consent:true,goodFaith:true }).success).toBe(true));
