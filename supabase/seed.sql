...
('demo-003','Ana Lucía Ferrer Gómez',63,false,'missing','moderator_reviewed','priority','2026-08-07T15:15:00-05:00','Mercado del Río, Ciudad Ejemplo','Su familia perdió contacto con ella después del cierre de varias vías.',3),
('demo-004','Samuel Ortega Peña',37,false,'possibly_trapped','moderator_reviewed','critical','2026-08-10T07:30:00-05:00','Sector aproximado del Edificio Mirador, Ciudad Ejemplo','Existen reportes revisados sobre el sector afectado.',2),
('demo-005','Camila Reyes Navarro',24,false,'located_alive','authority_confirmed','normal','2026-08-08T12:10:00-05:00','Centro de Atención Humanitaria, Ciudad Ejemplo','Fue localizada con vida y trasladada a un centro de atención.',5),
('demo-006','Jorge Iván Molina Torres',52,false,'deceased_confirmed','authority_confirmed','normal','2026-08-06T19:00:00-05:00','Sector Occidental, Ciudad Ejemplo','El fallecimiento fue confirmado dentro de estos datos ficticios.',1),
('demo-007','Sofía Cárdenas Gil',8,true,'reunited','authority_confirmed','normal','2026-08-09T09:25:00-05:00','Refugio Infantil, zona aproximada','Fue localizada y reunida con su familia.',3),
('demo-008','Diego Andrés Pardo Vélez',41,false,'missing','unverified','priority','2026-08-10T21:05:00-05:00','Estación Sur, Ciudad Ejemplo','Caso comunitario publicado con información aún no verificada.',0),
('demo-009','Rosa Elena Benítez Mora',70,false,'possibly_trapped','moderator_reviewed','critical','2026-08-10T06:45:00-05:00','Residencial Los Pinos, zona aproximada','Existe información revisada sobre una edificación afectada.',1),
('demo-010','Nicolás Herrera Cruz',19,false,'missing','moderator_reviewed','priority','2026-08-08T23:10:00-05:00','Puente Central, Ciudad Ejemplo','Varios reportes aprobados lo ubican cerca del puente.',6),
('demo-011','Mariana López Serrano',34,false,'missing','unverified','priority','2026-08-11T08:35:00-05:00','Ruta de Evacuación 4, Ciudad Ejemplo','Su familia reportó la pérdida de contacto durante un traslado.',1),
('demo-012','Andrés Felipe Rincón Díaz',46,false,'located_alive','authority_confirmed','normal','2026-08-07T17:20:00-05:00','Puesto Médico Norte, Ciudad Ejemplo','Fue localizado con vida y se confirmó su ingreso al puesto médico.',2),
('demo-013','Gabriela Suárez Nieto',27,false,'deceased_confirmed','authority_confirmed','normal','2026-08-06T14:50:00-05:00','Distrito Oriental, Ciudad Ejemplo','El fallecimiento fue confirmado dentro de estos datos ficticios.',2),
('demo-014','Óscar Medina Quintero',58,false,'missing','moderator_reviewed','priority','2026-08-09T20:15:00-05:00','Parque Industrial, Ciudad Ejemplo','Fue visto por última vez cerca de transporte comunitario.',3),
